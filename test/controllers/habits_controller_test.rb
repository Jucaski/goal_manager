...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference("Habit.count") do
      post habits_url, params: { habit: { completed_date: @habit.completed_date, title: @habit.title, user_id: @habit.user_id } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { completed_date: @habit.completed_date, title: @habit.title, user_id: @habit.user_id } }
